...
public class LabelRoutingMulticast extends Thread implements MessageUpcall {
    ...
    private static final Logger logger
            = Logger.getLogger(LabelRoutingMulticast.class);
    ...
    public LabelRoutingMulticast(LrmcIbis ibis, MessageReceiver m, MessageCache c, 
        ...
        this.sendQueue = new MessageQueue(
                new TypedProperties(ibis.properties()).getIntProperty(
                    "lrmc.queueSize", 32));
        receive = ibis.base.createReceivePort(LrmcIbis.baseType, "LRMCRing-" + name, this);
